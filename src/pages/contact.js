            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pb-16 lg:pb-36 lg:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="mt-8 space-y-8 md:space-y-0 md:flex md:justify-around">
                        <a href="tel:3862357270" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                        ...
                        <a href={site.siteMetadata.facebookPage} target="_blank" rel="noreferrer noopener" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
